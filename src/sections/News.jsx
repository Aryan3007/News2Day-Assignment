  ...
  return (
    <div className="">
      <div className="flex justify-between">
        ...
        >
          <CiCirclePlus className="text-2xl" /> <span>Create News</span>
        </button>
        {isModalOpen && (
          <>
            <dialog
              ...
              <div className="modal-box bg-white shadow-xl">
                ...
                <div className="modal-action">
                  <div className="gap-3 flex text-white" method="dialog">
                    ...
                    <button
                      className="px-3 py-1 bg-yellow-500 rounded-lg shadow-lg"
                      onClick={handleSubmit}
                    >
                      Save Draft
                    </button>{" "}
                    <button
                      className="px-3 py-1 bg-blue-500 rounded-lg shadow-lg"
                      onClick={handleSubmit}
                    >
                      Publish
                    </button>
